...
df = pd.read_csv('/Users/aeiwz/Library/CloudStorage/OneDrive-KhonKaenUniversity/KKUPC/Project/Alpha/KKUPC6602013/Re-analyse/Raw data/Dataset/KKUPC6602013_dataset_preprocessed.csv')
#Drop QC samples
...
#Make directory
# path folder
path_ = '/Users/aeiwz/Library/CloudStorage/OneDrive-KhonKaenUniversity/KKUPC/Project/Alpha/KKUPC6602013/Project Report/Project report/OPLS_result_path/element'

# Create directories if they don't exist
os.makedirs('/Users/aeiwz/Library/CloudStorage/OneDrive-KhonKaenUniversity/KKUPC/Project/Alpha/KKUPC6602013/Project Report/Project report/OPLS_result_path/element', exist_ok=True)
os.makedirs('/Users/aeiwz/Library/CloudStorage/OneDrive-KhonKaenUniversity/KKUPC/Project/Alpha/KKUPC6602013/Project Report/Project report/OPLS_result_path/element/hist_plot', exist_ok=True)
os.makedirs('/Users/aeiwz/Library/CloudStorage/OneDrive-KhonKaenUniversity/KKUPC/Project/Alpha/KKUPC6602013/Project Report/Project report/OPLS_result_path/element/loading_plot', exist_ok=True)
os.makedirs('/Users/aeiwz/Library/CloudStorage/OneDrive-KhonKaenUniversity/KKUPC/Project/Alpha/KKUPC6602013/Project Report/Project report/OPLS_result_path/element/score_plot', exist_ok=True)
os.makedirs('/Users/aeiwz/Library/CloudStorage/OneDrive-KhonKaenUniversity/KKUPC/Project/Alpha/KKUPC6602013/Project Report/Project report/OPLS_result_path/element/s_plot', exist_ok=True)
os.makedirs('/Users/aeiwz/Library/CloudStorage/OneDrive-KhonKaenUniversity/KKUPC/Project/Alpha/KKUPC6602013/Project Report/Project report/OPLS_result_path/main', exist_ok=True)
os.makedirs('/Users/aeiwz/Library/CloudStorage/OneDrive-KhonKaenUniversity/KKUPC/Project/Alpha/KKUPC6602013/Project Report/Project report/OPLS_result_path/element/Lingress', exist_ok=True)
...
# File name
name = [ "Gr1 vs Gr2", "Gr1 vs Gr3", "Gr1 vs Gr4", "Gr1 vs Gr5", "Gr1 vs Gr6", "Gr1 vs Gr7", "Gr1 vs Gr8",
...
'''    from lingress.Lingress import lin_regression
    ...
    test_lin = lin_regression(x=spectra, target=meta, label=meta, features_name=ppm)
    
    test_lin.create_dataset()
    test_lin.fit_model(adj_method='fdr_bh')
    report = test_lin.report()
    report.to_csv('{}/Lingress/Lin_report_{}.csv'.format(path_, name[i]))
    test_lin.spec_uniplot(p_value='q-value')
    test_lin.html_plot(path = path_, name = name[i])'''
#----------------------------------------------
